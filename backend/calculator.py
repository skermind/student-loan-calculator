...
def calculate_loan_overpayment(plan, outstanding, salary, bonus_rate, salary_growth, graduation_year, birth_year, extra_annual_overpayment=0):
    """
    Calculate yearly loan projections for a given loan plan.
    ...
    Args:
        ...
        graduation_year (int): The year the student graduated.
        birth_year (int): The birth year of the student.
        extra_monthly_pauments (int): possible extra payments made
    ...
    while current_year <= write_off_year:
        ...
        total_repayment = repayment + extra_annual_overpayment
        total_repayment = min(total_repayment, balance_due)

        outstanding = max(0, balance_due - total_repayment)
        ...
        rows.append({
            ...
            "Bonus": bonus,
            "TotalIncome": total_income,
            "OverPayment": extra_annual_overpayment,
